...
public class BitFileReader {
	...
	*/
	...
	/**
	* Creates a BitFileReader by opening a connection to a stream buffer,
	*/	
	public BitFileReader(InputStream ins) throws IOException {
	...
	/** Reads two bytes and returns it as an array of booleans. */
	public boolean[] readTwoBytes() throws IOException {
		boolean[] b = new boolean[16];	             // Array of read Bytes
